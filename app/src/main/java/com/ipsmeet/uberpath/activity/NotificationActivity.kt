...
class NotificationActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        todayNotification.apply {
            add(TransactionDataClass(R.drawable.img_reward, "Rewards", "Loyal user rewards!\uD83D\uDE18", "", "5m ago"))
            add(TransactionDataClass(R.drawable.img_money_send, "Money Transfer", "You have successfully sent money to Maria of...", "", "25m ago"))
        }

        val thisWeekNotification = arrayListOf<TransactionDataClass>()
        thisWeekNotification.apply {
            add(TransactionDataClass(R.drawable.img_credit_card_orange, "Payment Notification", "Successfully paid!\uD83E\uDD11", "", "Mar 20"))
            add(TransactionDataClass(R.drawable.img_money_receive, "Top Up", "Your top up is successfully!", "", "Mar 13"))
            add(TransactionDataClass(R.drawable.img_money_send, "Money Transfer", "You have successfully sent money to Maria of...", "", "Mar 09"))
            add(TransactionDataClass(R.drawable.img_discount, "Cashback 25%", "You have received cashback!", "", "Mar 20"))
            add(TransactionDataClass(R.drawable.img_credit_card_orange, "Payment Notification", "Successfully paid!\uD83E\uDD11", "", "Mar 13"))
        }
