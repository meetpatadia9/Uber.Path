...
class ProfileList3Adapter(val context: Context, val list: List<ProfileListDataClass>, private val listener: OnClick)
    : RecyclerView.Adapter<ProfileList3Adapter.ListViewHolder>(){
